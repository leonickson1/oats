...
struct OnboardingView: View {
    ...
    private var footer: some View {
        HStack {
            ...
            Spacer()
            // Onboarding never blocks: a fast reader can go straight through.
            // Anything still missing (mic, system audio, a model) is requested
            // on the permissions page, again the moment they press Record, and
            // is nudged by the banner on Home.
            HStack(spacing: 6) {
