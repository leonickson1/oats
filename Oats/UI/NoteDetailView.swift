...
struct NoteDetailView: View {
    ...
    // QA hook: OATS_QA_TAB=thoughts lands on the editor so its compact
    // toolbar can be screenshotted at companion width.
    @State private var tab: NoteTab =
        ProcessInfo.processInfo.environment["OATS_QA_TAB"] == "thoughts" ? .thoughts : .transcript
    ...
    private func load() {
        ...
        if ProcessInfo.processInfo.environment["OATS_QA_TAB"] == "thoughts" { tab = .thoughts }
