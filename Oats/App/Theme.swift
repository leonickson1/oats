...
// Oats uses Apple-native materials and semantic colors so light and dark
...
// The Oats mark: a listener dot with two hearing arcs. Drawn, not an SF symbol.
struct OatsMark: View {
