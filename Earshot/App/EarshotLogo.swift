...
struct EarshotTileLogoView: View {
    var size: CGFloat = 96

    var body: some View {
        Group {
            if let nsImage = EarshotLogo.tileImage(size: size) {
                ...
                RoundedRectangle(cornerRadius: size * 0.22, style: .continuous)
                    ...
                    .overlay(EarshotLogoView(color: Color(red: 0.96, green: 0.953, blue: 0.937), size: size * 0.52))
            }
        }
