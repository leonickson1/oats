...
// A model downloads once into Application Support/Earshot/whisper and then runs
...
enum WhisperEngine {
    ...
    static var baseDir: URL {
        ...
        let dir = appSupport.appendingPathComponent("Earshot/whisper", isDirectory: true)
